...
- All required metadata are filled out in the `module.json`:
   ...
   - See [module config](/build/module-config) for more details
...
You can also [host your own OpenGB module registry](/build/registry). This allows you to maintain complete control over your published modules.
