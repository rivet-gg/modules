...
Open Game Backend instead provides these same features as [modules](/concepts/modules) that can be modified & extended as needed. For example: [authentication](/modules/auth/overview) and [storage](https://github.com/rivet-gg/opengb-registry/tree/20f3bc34f8dea4382f442cdb1308834ea30b3fe9/modules/uploads) modules. These can be customized easily by running the `opengb fork` command.
