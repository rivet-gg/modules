...
<p>
  ...
  <span>[Source Code](https://github.com/rivet-gg/opengb-modules/tree/main/modules/auth_oauth)</span>
</p>
...
```bash
opengb module add auth_oauth
```

Or add the module `auth_oauth` to your `backend.json`.
</Tab>
