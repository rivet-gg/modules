...
| Source                                                                                                      | Name       | Public     |
| ----------------------------------------------------------------------------------------------------------- | ---------- | ---------- |
| [Source](https://github.com/rivet-gg/opengb-modules/tree/main/modules/identities/scripts/list.ts) | `list` | Yes |
...
const data = await backend.identities.list({
  // Request body
});
```

```gdscript Godot
var data = backend.identities.list({
  # Request body
})
```
...
void UYourClassName::PostRequest()
{
    ...
    Request->SetURL(TEXT("https://localhost:6420/modules/identities/scripts/list/call"));
...
let data = reqwest::Client::new()
    .post("https://localhost:6420/modules/identities/scripts/list/call")
...
```bash curl
curl -X POST "https://localhost:6420/modules/identities/scripts/list/call" \
