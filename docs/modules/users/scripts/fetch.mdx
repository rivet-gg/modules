...
title: "Fetch User"
description: ""
sidebarTitle: "Fetch User"
---

| Source                                                                                                      | Name       | Public     |
| ----------------------------------------------------------------------------------------------------------- | ---------- | ---------- |
| [Source](https://github.com/rivet-gg/opengb-modules/tree/main/modules/users/scripts/fetch.ts) | `fetch` | Yes |
...
const data = await backend.callUsersFetch({
  // Request body
});
```
...
var url = "https://localhost:6420/modules/users/scripts/fetch/call"
...
IEnumerator PostData() {
    ...
    var www = new UnityWebRequest("https://localhost:6420/modules/users/scripts/fetch/call", "POST");
...
void UYourClassName::PostRequest()
{
    ...
    Request->SetURL(TEXT("https://localhost:6420/modules/users/scripts/fetch/call"));
...
let data = reqwest::Client::new()
    .post("https://localhost:6420/modules/users/scripts/fetch/call")
...
```bash curl
curl -X POST "https://localhost:6420/modules/users/scripts/fetch/call" \
