...
sidebarTitle: "Set Lobby Ready"
---

| Source                                                                                                      | Name       | Public     |
| ----------------------------------------------------------------------------------------------------------- | ---------- | ---------- |
| [Source](https://github.com/rivet-gg/opengb-modules/tree/main/modules/lobbies/scripts/set_lobby_ready.ts) | `set_lobby_ready` | Yes |
...
const data = await backend.callLobbiesSetLobbyReady({
  // Request body
});
```
...
var url = "https://localhost:6420/modules/lobbies/scripts/set_lobby_ready/call"
...
IEnumerator PostData() {
    ...
    var www = new UnityWebRequest("https://localhost:6420/modules/lobbies/scripts/set_lobby_ready/call", "POST");
