...
sidebarTitle: "Destroy Lobby"
---

| Source                                                                                                      | Name       | Public     |
| ----------------------------------------------------------------------------------------------------------- | ---------- | ---------- |
| [Source](https://github.com/rivet-gg/opengb-modules/tree/main/modules/lobbies/scripts/destroy.ts) | `destroy` | Yes |
...
const data = await backend.callLobbiesDestroy({
  // Request body
});
```
...
var url = "https://localhost:6420/modules/lobbies/scripts/destroy/call"
...
IEnumerator PostData() {
    ...
    var www = new UnityWebRequest("https://localhost:6420/modules/lobbies/scripts/destroy/call", "POST");
...
void UYourClassName::PostRequest()
{
    ...
    Request->SetURL(TEXT("https://localhost:6420/modules/lobbies/scripts/destroy/call"));
...
let data = reqwest::Client::new()
    .post("https://localhost:6420/modules/lobbies/scripts/destroy/call")
...
```bash curl
curl -X POST "https://localhost:6420/modules/lobbies/scripts/destroy/call" \
