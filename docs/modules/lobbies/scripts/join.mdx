...
const data = await backend.callLobbiesJoin({
  // Request body
});
```
...
var url = "https://localhost:6420/modules/lobbies/scripts/join/call"
...
IEnumerator PostData() {
    ...
    var www = new UnityWebRequest("https://localhost:6420/modules/lobbies/scripts/join/call", "POST");
