...
const data = await backend.callLobbiesCreate({
  // Request body
});
```
...
var url = "https://localhost:6420/modules/lobbies/scripts/create/call"
...
IEnumerator PostData() {
    ...
    var www = new UnityWebRequest("https://localhost:6420/modules/lobbies/scripts/create/call", "POST");
