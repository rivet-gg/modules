...
<p>
  ...
  <span>[Source Code](https://github.com/rivet-gg/opengb-modules/tree/main/modules/steam)</span>
</p>
...
```bash
opengb module add steam
```

Or add the module `steam` to your `backend.json`.
</Tab>
