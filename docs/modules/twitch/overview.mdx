...
<p>
  ...
  <span>[Source Code](https://github.com/rivet-gg/opengb-modules/tree/main/modules/twitch)</span>
</p>
...
```bash
opengb module add twitch
```

Or add the module `twitch` to your `backend.json`.
</Tab>
