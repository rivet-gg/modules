...
var url = "https://localhost:6420/modules/friends/scripts/send_request/call"
...
IEnumerator PostData() {
    ...
    var www = new UnityWebRequest("https://localhost:6420/modules/friends/scripts/send_request/call", "POST");
