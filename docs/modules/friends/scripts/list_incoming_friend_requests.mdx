...
const data = await backend.callFriendsListIncomingFriendRequests({
  // Request body
});
```
...
var url = "https://localhost:6420/modules/friends/scripts/list_incoming_friend_requests/call"
...
IEnumerator PostData() {
    ...
    var www = new UnityWebRequest("https://localhost:6420/modules/friends/scripts/list_incoming_friend_requests/call", "POST");
