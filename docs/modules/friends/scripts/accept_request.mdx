...
| Source                                                                                                      | Name       | Public     |
| ----------------------------------------------------------------------------------------------------------- | ---------- | ---------- |
| [Source](https://github.com/rivet-gg/opengb-modules/tree/main/modules/friends/scripts/accept_request.ts) | `accept_request` | Yes |
...
const data = await backend.callFriendsAcceptRequest({
  // Request body
});
```
...
var url = "https://localhost:6420/modules/friends/scripts/accept_request/call"
...
IEnumerator PostData() {
    ...
    var www = new UnityWebRequest("https://localhost:6420/modules/friends/scripts/accept_request/call", "POST");
