...
| Source                                                                                                      | Name       | Public     |
| ----------------------------------------------------------------------------------------------------------- | ---------- | ---------- |
| [Source](https://github.com/rivet-gg/opengb-modules/tree/main/modules/friends/scripts/remove_friend.ts) | `remove_friend` | Yes |
...
const data = await backend.callFriendsRemoveFriend({
  // Request body
});
```
...
var url = "https://localhost:6420/modules/friends/scripts/remove_friend/call"
...
IEnumerator PostData() {
    ...
    var www = new UnityWebRequest("https://localhost:6420/modules/friends/scripts/remove_friend/call", "POST");
