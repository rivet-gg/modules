...
const data = await backend.call%%MODULE_NAME_PASCAL%%%%NAME_PASCAL%%({
  // Request body
});
```
...
var url = "https://localhost:6420/modules/%%MODULE_NAME%%/scripts/%%NAME%%/call"
...
IEnumerator PostData() {
    ...
    var www = new UnityWebRequest("https://localhost:6420/modules/%%MODULE_NAME%%/scripts/%%NAME%%/call", "POST");
