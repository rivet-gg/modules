...
import { Project, Module } from "../project/mod.ts";
...
export function validationUserError(message: string, path: string, config: any, ajv: Ajv, errors: ErrorObject[] | null | undefined) {
