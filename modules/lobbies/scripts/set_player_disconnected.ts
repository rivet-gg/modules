import { DestroyPlayersRequest } from "../utils/lobby_manager/rpc.ts";
...
export async function run(
  ...
  if (req.lobbyToken) {
	...
	await ctx.actors.lobbyManager.getOrCreateAndCall<undefined, DestroyPlayersRequest, undefined>(
		"default",
		undefined,
		"rpcDestroyPlayers",
