...
function Content() {
  ...
  if (state?.value === "failure") {
        ...
        <Container>
          <div className="flex justify-between w-full items-center">
            <p>
              ...
              {validationErrors.map((e) => e.info.moduleName).join(", ")}) have
              invalid configurations. Consult the docs for more information.
            </p>
            <Button
              asChild
              variant="outline"
    ...
    return (
      <Container>
        <Strong>OpenGB server has failed to start.</Strong> Please check the
