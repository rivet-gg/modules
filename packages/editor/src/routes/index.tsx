        ...
        <ModulesConfigForm {...data}>
          ...
          {Object.entries(data?.modules).map(([name, module]) => (
            <ModuleCard
              ...
              isRegistryExternal={
                data.registries[module.registryName]?.isExternal
              }
            />
          ))}
        </ModulesConfigForm>
  ...
  pendingComponent: () => (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Taking longer than expected? Take a look at the terminal, maybe
          something's wrong.
        </CardDescription>
      </CardHeader>
    </Card>
  ...
  errorComponent: ({ error }) => (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          This page has lost connection to OpenGB local server. Try refreshing
          the page, or take a look at the terminal for more information. In case
          the issue still persist, create an issue on{" "}
